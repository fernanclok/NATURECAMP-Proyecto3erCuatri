...
<html lang="en">
    ...
    <header>
        ...
        <section class="secundaria">
             <form method="POST" action="logic/ASIGNARINS.php" enctype="multipart/form-data">
             <h1 id="adminis">Asignar Grupo: </h1><br><br>
                  <input class="entradas" type="text"name="txtinstructor" maxlength="2", required pattern="[0-9]*" placeholder="Codigo de Instructor">
                  <br>
                  <select class="entradas" name="txtgroup" required>
                ...
                <input class="buton1" type="submit" value="Asignar Instructor">
